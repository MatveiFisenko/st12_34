...
(
	...
	'settings_locale' => 'Выставить язык сайта.',
	...
	'settings_twitter_configuration' => 'Выбрать хэштег, который будет показан в твиттере',
	
	//Map Settings
	'settings_default_location' => 'Страна, в которой будет установлена платформа',
